...
- 直接试玩 v0.1：<https://ice.minitechs.xyz/>

如果你有脑洞：

- 提交一个玩法建议：<https://my.feishu.cn/share/base/form/shrcnfn9KV1BpJ5mNbOZXJNsBIe>

如果你只想花 3 秒参与：

- 帮我选下一版先改哪个方向：A 工人别再犯傻 / B 熊更有压迫感 / C 失败动画更离谱 / D 加分数和排行榜。
...
> 看完 / 玩完后，只选一个字母：A 工人别再犯傻、B 熊更有压迫感、C 失败动画更离谱、D 加分数和排行榜。
...
当前 v0.1 还保留了一些很适合吐槽的地方，比如工人路线、资源搬运、熊的压迫感和失败反馈。它们不一定都要今天修完，正好可以作为下一版投票项。
